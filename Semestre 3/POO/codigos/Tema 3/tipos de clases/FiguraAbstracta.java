...
class PruebaFigura{
	public static void main(String[] args) {
		...
		Figura cir2 = new Circulo(4);
		System.out.println("Area del circulo en referencia cir2: " + cir2.area() + " " + cir2.saludo());		

		//Figura f1 = new Figura(); //No se puede crear una instancia de una clase abstracta.
