...
class Biblioteca{
	...
	/**
	*Vista:Los metodos de vista permiten visualizar los elementos de la base de datos y ver su estado.
	*/
	...
	/**
	*Modelo: Encapsula la informacion de la base de datos y define como se pueden agregar editoriales
	*/
	...
	/**
	*Modelo: Encapsula la informacion de la base de datos y define como se pueden agregar autores a la base de datos
	*/
	...
	/**
	*Modelo: Encapsula la informacion de la base de datos y define como se pueden agregar libros al catalogo.
	*/
	...
	/**
	*Modelo: Encapsula la informacion de la base de datos y define como se pueden agregar libros a la biblioteca
	*/
	...
	/**
	*Vista: corresponde a la parte del metodo main, que mostrar la informacion almacenada en la base de datos.
	*Ademas permite el agregar elementos a la base.
	*/
