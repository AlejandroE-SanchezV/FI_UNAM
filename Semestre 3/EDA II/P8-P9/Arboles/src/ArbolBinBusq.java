...
public class ArbolBinBusq extends ArbolBin{
    ...
    /*
    public Nodo agregarNodoBusq(int dato){
        if(root==null){
            Nodo nuevo = new Nodo(dato,null);
            root=nuevo;
        }else{
            int valor=root.valor;
            if(dato>valor){
                Nodo nodoA = busquedaDer();
                return nodoA;
            }
            if(dato<valor){
               Nodo nodoB = busquedaIzq(dato);
               return nodoB;
            } 
        }
        return null;
    ...
    /*public void add(Nodo padre,Nodo hijo,int valor){
    ...
    /*public Nodo agregarNodoBusq2(Nodo raiz, Nodo padre,int dato){
        if(raiz==null){
            ...
            int valorR=raiz.valor;
            if(dato<valorR){
               agregarNodoBusq2(raiz.izq,raiz,dato);
               lado=0;
            }else{
                agregarNodoBusq2(raiz.der,raiz,dato);
                lado=1;
            } 
        }
        return null;
    ...
    /*public Nodo agregarNodoBusq(Nodo raiz, Nodo padre,int dato){
        if(raiz==null){
            Nodo nuevo = new Nodo(dato,padre);
            raiz=nuevo;
            System.out.println("Valor:"+raiz.valor);
