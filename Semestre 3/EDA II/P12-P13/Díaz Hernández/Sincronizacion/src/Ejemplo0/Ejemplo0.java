...
package Ejemplo0;
    ...
    public class Ejemplo0{  
        public static void main(String args[]){  
            ...
            t2.start();
            t1.start();  //Se realiza en orden de invocacion del metodo cuando estan sincronizados, en caso contrario solo se ejecutan una tras otra 
              //impresion sin importar los valores
        }  
    }  
