...
public class Polifase {
    ...
    public Polifase(String rutaCarpeta, String rutaArchivo){
        this.direccionL=rutaArchivo;
        this.direccionE2=rutaCarpeta+"\\F2.txt";
        this.direccionE1=rutaCarpeta+"\\F1.txt";
        this.direccionE0=rutaCarpeta+"\\F0.txt";
        this.direccionE3=rutaCarpeta+"\\F3.txt";
    }
    ...
    * @param opcion Este parametro permite el ejecutar el tipo de ordenamiento posteriormente de forma automatica, sin indicarlo como en los anteriores
     ...
     * @param apellidos
    */
    public void polifaseParteDos(int opcion, String rutaCarpeta){
        ...
        ordenFinal(linea,direccionF1,opcion);
   }
   /**
    ...
    * @param opcion Indica la opcion en caso de que sea ordenamiento por Nombre o por Apellido
     * @param apellidos
    */
    public void ordenFinal(int linea,String direccionF,int opcion){
        String aux;
        if(opcion==1){
            try{
            ...
            try{
                ...
                for(int i=0;i<ln.length;i++){
                    if(miTablita1.get(ln[i])==null || miTablita2.get(ln[i])==null){
                        ...
                        archivoWB.write(miTablita1.get(ln[i])+","+ln[i]+","+miTablita2.get(ln[i])+"\n");
                    }    
                }
               archivoRB.close();
               archivoWB.close();
