...
public class SemaphoreTest {
	// max 4 people
	static Semaphore semaphore = new Semaphore(4); //Numero de elementos permitidos a la informacion
		...
		public void run() {
			...
			try {
				...
				System.out.println(name + " : available Semaphore permits now: " 
								+ semaphore.availablePermits()); //muestra los elementos que tienen acceso
				...
				try {
					...
					for (int i = 1; i <= 5; i++) {
						...
						// sleep 1 second
						Thread.sleep(1000);//Permite que los demas hilos obtengan el permiso
